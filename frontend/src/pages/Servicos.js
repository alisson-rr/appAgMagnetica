  ...
  const openModal = (procedimento = null) => {
    if (procedimento) {
      ...
      setFormData({
        ...
        duracao_minutos: procedimento.duracao_minutos?.toString() || '',
        valor: procedimento.valor?.toString() || '',
        categoria: procedimento.categoria || '',
        orientacoes: procedimento.orientacoes || ''
      });
    } else {
      ...
      <div className="flex items-center justify-between">
        ...
        <Dialog open={modalOpen} onOpenChange={setModalOpen}>
          ...
          <DialogContent className="max-w-2xl">
            <DialogHeader>
              <DialogTitle>{editingProcedimento ? 'Editar Serviço' : 'Novo Serviço'}</DialogTitle>
            </DialogHeader>
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                ...
                <Textarea
                  ...
                  placeholder="Orientações pós-procedimento..."
                />
              </div>
