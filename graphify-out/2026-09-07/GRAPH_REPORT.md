# Graph Report - appAgMagnetica  (2026-09-07)

## Corpus Check
- 187 files · ~332,578 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1927 nodes · 3228 edges · 202 communities (93 shown, 82 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 2 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `976b7271`
...
- alert.jsx
- input-otp.jsx
- test_schema_compatibilidade.py
- ConsultaFake
- delete
- tabs.jsx
- toggle-group.jsx
...
- public.fn_buscar_slots
- 6. Contratos das ferramentas
- public.consulta
- public.v_clinica_detalhes
...
1. `cn()` - 199 edges
2. `banco_com()` - 39 edges
3. `banco_com()` - 39 edges
4. `http_com()` - 38 edges
5. `get_user_clinica_id()` - 35 edges
6. `amanha_as()` - 34 edges
7. `http_com()` - 33 edges
8. `chamar()` - 25 edges
9. `AiError` - 24 edges
10. `criar_agendamento()` - 23 edges

## Surprising Connections (you probably didn't know these)
- `AlertDialogOverlay` --calls--> `cn()`  [EXTRACTED]
  apps/dashboard/src/components/ui/alert-dialog.jsx → apps/dashboard/src/lib/utils.js
...
## Communities (202 total, 82 thin omitted)

### Community 0 - "server.py"
Cohesion: 0.11
Nodes (31): Ponte entre as funções serverless do Vercel e o backend em `services/api`. O…, HTTPAuthorizationCredentials, put, ClienteCreate, ClienteUpdate, create_access_token(), create_cliente(), create_horario_clinica() (+23 more)

### Community 1 - "Clientes.jsx"
Cohesion: 0.19
Nodes (17): HorariosEditor(), EmptyState(), Loading(), PageHeader(), Card, DialogContent, DialogHeader(), DialogTitle (+9 more)

### Community 2 - "App.jsx"
Cohesion: 0.07
Nodes (30): Agenda, App(), AppContent(), Cadastro, Clientes, Comissoes, Configuracoes, EscolherPlano (+22 more)

### Community 3 - "devDependencies"
Cohesion: 0.04
Nodes (47): dependencies, lucide-react, react, react-dom, devDependencies, autoprefixer, eslint, @eslint/js (+39 more)
...
### Community 6 - "Corte vertical seguro — Agenda Magnética"
Cohesion: 0.07
...
Cohesion: 0.08
Nodes (27): App(), formatPhone(), initialForm, LeadForm(), LegalDialog(), Props, planos, Plans() (+19 more)
...
### Community 13 - "bootstrap_schema.sql"
Cohesion: 0.31
Nodes (14): public, public.agenda_bloqueio, public.area_atuacao, public.assinaturas, public.cliente, public.consulta, public.disponibilidade_profissional, public.horario_clinica (+6 more)
...
### Community 16 - "test_webhook_config.py"
Cohesion: 0.07
Nodes (26): build_webhook_payload(), _config(), connect_instance(), create_instance(), fetch_instances(), get_connection_state(), logout_instance(), Integração do backend com a Evolution API. (+18 more)
...
### Community 18 - "cn"
Cohesion: 0.05
Nodes (48): AccordionContent, AccordionItem, AccordionTrigger, Avatar, AvatarFallback, AvatarImage, Breadcrumb, BreadcrumbEllipsis() (+40 more)
...
### Community 27 - "1. O que foi corrigido"
Cohesion: 0.15
Nodes (13): 1.10 Textos ao cliente (`montar resposta`), 1.11 Rastro, validador e documentação, 1.1 Entrada: o que o fluxo aceita e o que descarta, 1.2 Datas e horas (`resolver e decidir`), 1.3 Busca de disponibilidade, 1.4 Escolha de horário e ciclo da ação pendente, 1.5 Serviço e profissional por nome, 1.6 Reagendar e cancelar (+5 more)
...
### Community 34 - "test_schema_compatibilidade.py"
Cohesion: 0.10
...
### Community 36 - "delete"
Cohesion: 0.24
Nodes (10): delete, delete_bloqueio(), delete_cliente(), delete_consulta(), delete_horario_clinica(), delete_procedimento(), delete_profissional(), Exception (+2 more)
...
### Community 41 - "get_whatsapp_status"
Cohesion: 0.12
Nodes (16): AutomacaoUpdate, equipe_agendavel(), estado_da_conexao(), get_implantacao(), get_whatsapp_status(), montar_implantacao(), numero_conectado(), Existe profissional que a automação consiga oferecer de verdade. Ativo, com… (+8 more)

### Community 42 - "7. Quarta rodada: a revisão que olhou a conversa, não só o código"
Cohesion: 0.29
Nodes (7): 7.1 O defeito mais caro: a automação calava por 12 horas, 7.2 O resto do que a conversa cobrava, 7.3 As regressões que a própria terceira rodada tinha criado, 7.4 O alerta de falha vazava dado do cliente, 7.5 A verificação, de novo, 7.6 O que continua aberto, 7. Quarta rodada: a revisão que olhou a conversa, não só o código

### Community 43 - "Correções da automação — rodada de setembro de 2026"
Cohesion: 0.33
Nodes (5): 11. Validação executada, 3. O que **não** foi corrigido e continua aberto, 4. Decisões que ficaram para o dono, 5. Próximo passo, na ordem, Correções da automação — rodada de setembro de 2026

### Community 44 - "10. O contexto da empresa: o que o dono escreve e a recepção responde"
Cohesion: 0.22
Nodes (9): 10.1 O campo já existia; o fio é que estava cortado, 10.2 A parte que quase passou em branco: o filtro engolia a resposta certa, 10.3 O texto entra no prompt, então é fronteira, 10.4 A sétima revisão adversarial: 20 achados, e o pior era meu, 10.5 A oitava revisão: parar de empilhar e separar as perguntas, 10.6 A nona revisão: o que cada simplificação da § 10.5 tinha levado junto, 10.7 A verificação, 10.8 O que continua de fora (+1 more)

### Community 46 - "ai_api.py"
Cohesion: 0.06
Nodes (93): Any, date, Decimal, AiError, atualizar_cliente(), AtualizarClienteRequest, autenticar_automacao(), BaseAutomacao (+85 more)

### Community 48 - "8. Quinta rodada: catálogo de verdade e a guarda clínica pela raiz"
Cohesion: 0.33
Nodes (6): 8.1 O casamento por raiz agendava o serviço errado, 8.2 A guarda clínica, pela terceira vez — e agora pela raiz, 8.3 O resto, 8.4 A verificação, pela quarta vez, 8.5 O que continua aberto, 8. Quinta rodada: catálogo de verdade e a guarda clínica pela raiz

### Community 49 - "test_erros_api.py"
Cohesion: 0.29
...
### Community 70 - "dashboard/vercel.json"
Cohesion: 0.40
Nodes (4): buildCommand, framework, outputDirectory, rewrites

### Community 73 - "9. Sexta rodada: os itens que a § 8.5 tinha deixado abertos"
Cohesion: 0.40
Nodes (5): 9.1 O que a rodada fechou, 9.2 O que foi recusado, 9.3 A verificação, 9.4 O que continua aberto, 9. Sexta rodada: os itens que a § 8.5 tinha deixado abertos

### Community 91 - "2. Segunda rodada: a revisão adversarial e o que ela obrigou a refazer"
Cohesion: 0.50
Nodes (4): 2.1 O que a segunda rodada corrigiu, 2.2 O que a segunda rodada deixou aberto, e por quê, 2.3 Achados **refutados** — não recrie estes, 2. Segunda rodada: a revisão adversarial e o que ela obrigou a refazer

### Community 92 - "6. Terceira rodada: o que a segunda revisão obrigou a refazer"
Cohesion: 0.50
Nodes (4): 6.1 As correções, 6.2 A outra metade: verificação executável, 6.3 Teto conhecido que ficou de pé, 6. Terceira rodada: o que a segunda revisão obrigou a refazer

### Community 113 - "Automação de atendimento — homologação"
Cohesion: 0.05
Nodes (36): 1. Por empresa — o botão do painel, 2. Por workflow — desativar no n8n, 3. Por token — rotacionar a credencial, A automação não fala com o banco, Ajustes rápidos, Antes de ativar, Automação de atendimento — homologação, Chaves do Redis (+28 more)

### Community 114 - "test_regras.mjs"
Cohesion: 0.09
Nodes (31): agendar(), AQUI, CATALOGO_BARBEARIA, CATALOGO_CURTO, CATALOGO_FISIO, CATALOGO_PSI, codigo(), confirmar() (+23 more)
...
### Community 116 - "public.fn_buscar_slots"
Cohesion: 0.22
Nodes (8): public.fn_buscar_slots(), public.agenda_bloqueio, public.consulta, public.disponibilidade_profissional, public.horario_clinica, public.procedimento, public.profissional, public.profissional_procedimento
...
### Community 120 - "public.v_clinica_detalhes"
Cohesion: 0.25
Nodes (7): public.v_clinica_detalhes, public.area_atuacao, public.horario_clinica, public.info_clinica, public.procedimento, public.profissional, public.profissional_procedimento
...
Cohesion: 0.18
Nodes (10): Casos da rodada de correções de setembro (T34 a T71), Casos obrigatórios, Contrato da API, Invariantes da quarta rodada, Invariantes da quinta rodada, Invariantes da rodada de setembro, Invariantes da terceira rodada, Matriz de testes — Atendimento V2 (+2 more)

### Community 134 - "validar_workflow.py"
Cohesion: 0.47
Nodes (5): falhas_de_forma(), falhas_do_workflow(), main(), Validador do workflow de atendimento (biblioteca padrão apenas). Uso: python…, Regras que valem para QUALQUER workflow do projeto: inativo, sem segredo, sem…
...
### Community 139 - "test_onboarding.py"
Cohesion: 0.08
Nodes (65): banco_com(), conectada(), dubles_da_evolution(), em(), empresa(), evolution_muda(), http_com(), pronto_para_ativar() (+57 more)

### Community 141 - "onboarding.js"
Cohesion: 0.13
Nodes (25): ConexaoWhatsApp(), ROTULOS_ESTADO, atendenteSchema, DIAS_SEMANA, emailOpcional, formatarNumeroWa(), HORAS, ITENS_IMPLANTACAO (+17 more)
...
### Community 143 - "Onboarding.jsx"
Cohesion: 0.14
Nodes (27): CampoErro(), descricaoDoCampo(), ProfissionalForm(), vazio, ServicoForm(), Switch, Textarea, agruparHorarios() (+19 more)

### Community 144 - "test_ai_api.py"
Cohesion: 0.04
Nodes (28): parametrize, Regras e contrato das rotas `/api/ai/*`, sem rede. O comportamento contra o…, `status=neq.cancelada` é filtro de URL, não valor do vocabulário., `agendavel: false` é transferência para pessoa, não 'sem vaga hoje'., O painel não pode passar a receber o envelope da automação., O JWT do dashboard não pode virar credencial de máquina., O índice único é global: sem prefixo, duas empresas colidiriam., Uma requisição aceita não é prova de gravação. (+20 more)

### Community 145 - "test_ai_api_integracao.py"
Cohesion: 0.08
Nodes (47): as_horas(), Cenario, chamar(), conexao(), dia_alvo(), _do_env(), _executar(), http() (+39 more)

### Community 146 - "banco_com"
Cohesion: 0.08
Nodes (44): banco_com(), cliente_http(), http_com(), fixture, Estado desejado já no banco: repetir não pode virar HORARIO_INDISPONIVEL., `1994-13-45` casa com o padrão AAAA-MM-DD mas não é uma data. Como texto,…, A data vem de uma conversa interpretada por um modelo. "faço aniversário em…, Pelo menos um dos quatro campos permitidos é obrigatório. (+36 more)
...
Cohesion: 0.13
Nodes (12): BancoFake, ErroDeBanco, Exception, Os joins embutidos que o PostgREST devolve no select da consulta., Erro do PostgREST com SQLSTATE, na forma que `codigo_postgres` lê., `corridas`: fila por tabela de `(sqlstate, linha_concorrente)`. Cada escrita…, RespostaFake, test_consulta_de_outra_empresa_nao_e_encontrada() (+4 more)

### Community 153 - "get_user_clinica_id"
Cohesion: 0.19
Nodes (17): get, get_areas_atuacao(), get_bloqueios(), get_cliente(), get_clientes(), get_consultas(), get_dashboard_stats(), get_disponibilidade_profissional() (+9 more)

### Community 154 - "amanha_as"
Cohesion: 0.09
Nodes (30): amanha_as(), consulta_em(), A chave da criação não pode ser sobrescrita pela remarcação., Linha de `consulta` como o PostgREST devolve, com os joins embutidos., `extra=forbid` impede a automação de tentar escolher a empresa., Desativar o profissional depois não apaga o agendamento já gravado., 23505 no índice da chave: a repetição concorrente já gravou., Idempotência só vale para o MESMO pedido. (+22 more)
...
### Community 156 - "dinheiro_para_banco"
Cohesion: 0.33
Nodes (6): dinheiro_para_banco(), Texto para o corpo JSON do PostgREST. `Decimal` não é serializável em JSON e…, create_procedimento(), ProcedimentoCreate, ProcedimentoUpdate, update_procedimento()
...
### Community 159 - "utils.js"
Cohesion: 0.18
Nodes (12): vazio, Button, Checkbox, Input, Label, labelVariants, politicaPrivacidade, termosDeUso (+4 more)
...
### Community 182 - "post"
Cohesion: 0.13
Nodes (17): BloqueioCreate, create_bloqueio(), criar_instancia_whatsapp(), disconnect_whatsapp(), garantir_instancia(), get_whatsapp_qrcode(), instancia_do_usuario(), montar_nome_instancia() (+9 more)
...
### Community 185 - "assert_owned_record"
Cohesion: 0.20
Nodes (11): add_procedimentos_profissional(), assert_owned_record(), ConsultaCreate, ConsultaUpdate, create_consulta(), delete_disponibilidade(), DisponibilidadeItem, get_procedimento_da_empresa() (+3 more)

### Community 187 - "get_me"
Cohesion: 0.33
...
## Knowledge Gaps
- **638 isolated node(s):** `python`, `$schema`, `style`, `rsc`, `tsx` (+633 more)
...
- **Why does `cn()` connect `cn` to `Clientes.jsx`, `menubar.jsx`, `Onboarding.jsx`, `use-toast.js`, `command.jsx`, `dropdown-menu.jsx`, `form.jsx`, `alert-dialog.jsx`, `table.jsx`, `carousel.jsx`, `drawer.jsx`, `navigation-menu.jsx`, `sheet.jsx`, `utils.js`, `alert.jsx`, `input-otp.jsx`, `tabs.jsx`, `toggle-group.jsx`, `badge.jsx`?**
  _High betweenness centrality (0.034) - this node is a cross-community bridge._
- **Why does `dependencies` connect `dependencies` to `dashboard/package.json`, `react`, `@radix-ui/react-toast`, `axios`, `date-fns-tz`, `date-fns`, `@dnd-kit/core`, `@dnd-kit/sortable`, `embla-carousel-react`, `@hookform/resolvers`, `input-otp`, `next-themes`, `lucide-react`, `@radix-ui/react-alert-dialog`, `@radix-ui/react-avatar`, `@radix-ui/react-aspect-ratio`, `@radix-ui/react-context-menu`, `@radix-ui/react-dialog`, `@radix-ui/react-dropdown-menu`, `@radix-ui/react-hover-card`, `@radix-ui/react-label`, `@radix-ui/react-menubar`, `@radix-ui/react-navigation-menu`, `@radix-ui/react-popover`, `@radix-ui/react-select`, `@radix-ui/react-radio-group`, `@radix-ui/react-scroll-area`, `react-day-picker`, `@radix-ui/react-separator`, `@radix-ui/react-slider`, `@radix-ui/react-switch`, `@radix-ui/react-tabs`, `class-variance-authority`, `@radix-ui/react-toggle-group`, `@radix-ui/react-tooltip`, `@radix-ui/react-accordion`, `@radix-ui/react-progress`, `react-dom`, `react-resizable-panels`, `react-router-dom`, `sonner`, `tailwind-merge`, `tailwindcss-animate`, `vaul`, `zod`, `cmdk`?**
